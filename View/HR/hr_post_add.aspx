...
<head>
    ...
    <script type="text/javascript">
        ...
        function positionselected(newval) {
            ...
            $.ajax({
                type: "GET",
                url: "hr_position.getlevel.xhd", /* 注意后面的名字对应CS的方法名称 */
                data: { id: newval, rnd: Math.random() }, /* 注意参数的格式和名称 */
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "hr_post.form.xhd", /* 注意后面的名字对应CS的方法名称 */
