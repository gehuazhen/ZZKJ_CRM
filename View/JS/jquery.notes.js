$(document).ready(function () {
    ...
    $('#note-submit').live('click', function (e) {
        ...
        $(this).replaceWith('<img src="../../images/fancybox/img/ajax_load.gif" style="margin:30px auto;display:block" />');
        ...
        $.post('Personal_notes.save.xhd', data, function (msg) {
...
function make_draggable(elements) {
    ...
    elements.draggable({
        ...
        stop: function (e, ui) {
            ...
            //alert(JSON.stringify($(ui.helper).attr("id")));
            $.get('Personal_notes.update.xhd', {
                x: ui.position.left,
                y: ui.position.top,
                z: zIndex,
