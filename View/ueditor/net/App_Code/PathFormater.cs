...
namespace XHD.View
{
    ...
    public static class PathFormatter
    {
        ...
        {
            return Format(originFileName, pathFormat, null);
        }

        public static string Format(string originFileName, string pathFormat, string company)
        {
            ...
            pathFormat = pathFormat.Replace("{company}", company);
