...
namespace XHD.Controller
{
    ...
    public class EmailHelper
    {
        ...
        {
            get { return _FormEmailPassword; }
            set { this._FormEmailPassword = value; }
        }
        ...
        public EmailHelper(string host,int port,bool ssl,string user,string pwd, string toList, string subject, string body)
        {
            this.SmtpHost = host;
            this.SmtpPort = port;
            this.EnableSsl = ssl;
            this.FromEmailAddress = user;
            this.FormEmailPassword = pwd;
            this.ToList = toList;
        ...
        /// 构造函数
        /// </summary>
        /// <param name="mailid">邮箱信息ID</param>
        /// <param name="toList">收件人列表</param>
        /// <param name="subject">邮件标题</param>
        /// <param name="isBodyHtml">邮件正文是否为Html格式</param>
        /// <param name="body">邮件正文</param>
        public EmailHelper(string host, int port, bool ssl, string user, string pwd, string toList, string subject, bool isBodyHtml, string body)
        {
            this.SmtpHost = host;
            this.SmtpPort = port;
            this.EnableSsl = ssl;
        ...
        /// <param name="isBodyHtml">邮件正文是否为Html格式</param>
        /// <param name="body">邮件正文</param>
        public EmailHelper(string host, int port, bool ssl, string user, string pwd, string toList, string ccList, string bccList, string subject, bool isBodyHtml, string body)
        {
            this.SmtpHost = host;
            this.SmtpPort = port;
            this.EnableSsl = ssl;
        ...
        public EmailHelper(string host, int port, bool ssl, string user, string pwd, string toList, string ccList, string bccList, string subject, bool isBodyHtml, string body, List<Attachment> attachmentList)
        {
            this.SmtpHost = host;
            this.SmtpPort = port;
            this.EnableSsl = ssl;
        ...
        public void Send()
        {
            ...
            mm.From = new MailAddress(this.FromEmailAddress, "小黄豆CRM", Encoding.GetEncoding(936));
