...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid5").ligerGrid({
                columns: [
                    ...
                    {
                        display: '跟进人', name: 'yy', width: 120, render: function (item) {
                            if (!item.yy)
                                item.yy = "【系统】未分类";
                            return item.yy;
                        }
        ...
        function doserch() {
            ...
            $.ajax({
                url: "CRM_follow.Compared_empcusfollow.xhd", type: "POST",
                data: serchtxt,
                dataType: 'json',
                beforeSend: function () {
                ...
                success: function (responseText) {
                    manager._setUrl("CRM_follow.Compared_empcusfollow.xhd?" + serchtxt);
