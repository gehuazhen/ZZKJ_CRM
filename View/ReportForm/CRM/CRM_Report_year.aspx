    ...
    <script type="text/javascript">
        ...
        function initSelect() {
            $("#stype").ligerComboBox({
                width: 100,
                data: [
                    { 'text': '客户类型', 'id': 'cus_type' },
                    { 'text': '客户级别', 'id': 'cus_level' },
                    { 'text': '客户来源', 'id': 'cus_source' }
                ],
                initValue: 'cus_type'
            })
            var d = new Date();
        ...
        function doserch() {
            ...
            $.ajax({
                url: "Reports_CRM.CRM_Reports_year.xhd", type: "POST",
                data: serchtxt,
                dataType: 'json',
                beforeSend: function () {
                ...
                success: function (responseText) {
                    manager._setUrl("Reports_CRM.CRM_Reports_year.xhd?" + serchtxt);                   
