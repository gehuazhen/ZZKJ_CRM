...
namespace XHD.Service.XHD_Service {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="XHD_ServerSoap", Namespace="http://tempuri.org/")]
    public partial class XHD_Server : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public XHD_Server() {
            this.Url = global::XHD.Service.Properties.Settings.Default.XHD_Service_XHD_Service_XHD_Server;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/Suggest", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public int Suggest(string Suggestion, string QQ, string tel, string email, string SuggestContent) {
            object[] results = this.Invoke("Suggest", new object[] {
                        Suggestion,
                        QQ,
                        tel,
                        email,
        ...
        /// <remarks/>
        public void SuggestAsync(string Suggestion, string QQ, string tel, string email, string SuggestContent) {
            this.SuggestAsync(Suggestion, QQ, tel, email, SuggestContent, null);
        }
        
        /// <remarks/>
        public void SuggestAsync(string Suggestion, string QQ, string tel, string email, string SuggestContent, object userState) {
            ...
            this.InvokeAsync("Suggest", new object[] {
                        Suggestion,
                        QQ,
                        tel,
                        email,
                        SuggestContent}, this.SuggestOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void GetVersionAsync(string guid, string name) {
            this.GetVersionAsync(guid, name, null);
        }
        
        /// <remarks/>
        public void GetVersionAsync(string guid, string name, object userState) {
