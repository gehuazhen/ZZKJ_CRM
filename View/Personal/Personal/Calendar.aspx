    ...
    <div>
        <div id="calhead" style="padding-left: 1px; padding-right: 1px;">
            ...
            <div id="caltoolbar" class="ctoolbar">
                ...
                <div id="showdaybtn" class="fbutton" style="margin-left: 10px;">
                ...
                <div id="showreflashbtn" class="fbutton" style="margin-left: 10px;">
                    <div><span title='刷新' class="showdayflash">刷新</span></div>
                </div>

                <div id="sfprevbtn" title="上一个" class="fbutton" style="margin-left: 10px;">
                    <span class="fprev"></span>
                </div>
                <div id="sfnextbtn" title="下一个" class="fbutton">
                    <span class="fnext"></span>
                </div>
                <div class="fshowdatep fbutton" style="display: none;">
                    <div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var op = {
                ...
                //autoload:true,
                url: "Personal_Calendar.get.xhd",
                quickAddUrl: "Personal_Calendar.quickadd.xhd",
                quickUpdateUrl: "Personal_Calendar.quickupdate.xhd",
                quickDeleteUrl: "Personal_Calendar.quickdel.xhd" //快速删除日程的
            ...
            function f_save(item, dialog) {
                ...
                if (issave) {
                    ...
                    $.ajax({
                        url: "Personal_Calendar.save.xhd", type: "POST",
                        data: issave,
            ...
            function Edit(data) {
                ...
                if (data) {
                    f_openWindow(eurl, "修改日程", 620, 380, f_save);
                }
            }
            function View(data) {
