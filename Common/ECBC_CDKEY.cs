...
namespace XHD.Common
{
    ...
    public class SoftReg
    {
        ...
        public string getMNum()
        {
            ...
            string strMNum = DEncrypt.DEncrypt.Encrypt(strNum);
            ; //从生成的字符串中取出前24个字符做为机器码  
            string MathineCode = "XMK" + strMNum.Substring(0, 2) + "-" + strMNum.Substring(1, 5) + "-" +
                                 strMNum.Substring(6, 5) + "-" + strMNum.Substring(12, 5) + "-" +
                                 strMNum.Substring(17, 5) + "-" + strMNum.Substring(22, 5) + "-" +
                                 strMNum.Substring(27, 5);
        ...
        {
            string MNum = DEncrypt.DEncrypt.Encrypt(getMNum()); //获取注册码
            MNum = MNum.ToUpper();
            string RegKey = "XHDRC-" + MNum.Substring(5, 5) + "-" + MNum.Substring(19, 5) + "-" + MNum.Substring(36, 5) +
                            "-" + MNum.Substring(49, 5);
