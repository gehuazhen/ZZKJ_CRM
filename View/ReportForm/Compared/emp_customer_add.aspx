...
<head>
    ...
    <script type="text/javascript">
        ...
        function doserch() {
            var sendtxt = "&idlist=" + $("#tree1_val").val() + "&rnd=" + Math.random();
            ...
            $.ajax({
                url: "CRM_Customer.Compared_empcusadd.xhd", type: "POST",
                data: serchtxt,
                dataType: 'json',
                beforeSend: function () {
                ...
                success: function (responseText) {
                    manager._setUrl("CRM_Customer.Compared_empcusadd.xhd?" + serchtxt);
